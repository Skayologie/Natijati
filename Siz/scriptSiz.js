...
function calcAllThis() {
      ...
      var allNoteFLMo3amil = notes[0]+notes[1]+notes[2]+notes[3]+notes[4]+notes[5]+notes[6]+notes[7]+notes[8]+notes[9]+notes[10]
      finallResult = allNoteFLMo3amil / 37
...
function doAllThis() {
      ...
      calc_3('resultMATH',3,'test10','test11','test12',7)
      calc_3('resultFilo',4,'test13','test14','test15',2)
      calc_4('resultpc',5,'test16','test17','test18','test19',7)
      calc_3('resulteng',6,'test20','test21','test22',2)
      calc_3('resultar',7,'test23','test24','test25',2)
      calc_5('resultfr',8,'test26','test27','test28','test29','test30',4)
      calc_4('resultsvt',9,'test31','test32','test33','test34',7)
      calc_1('resultmob',10,'test35',1)
}